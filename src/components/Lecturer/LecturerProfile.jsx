            ...
            <div className="bg-white/95 backdrop-blur-sm rounded-xl shadow-custom border border-beige overflow-hidden card-hover animate-fade-in">
                <div className="p-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            <label className="block text-brown-light text-sm mb-1">Lcturer nip (nip)</label>
                        ...
                        <div>
                            <label className="block text-brown-light text-sm mb-1">murid </label>
                            <div className="text-brown-dark text-lg">{murid}</div>
                        </div>
